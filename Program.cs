...
/*  
 *  NOTE: The main() had to be renamed to NotMain() because when you run the unit test cases, it gets confused as to which main you're talking about. So to specify, 
 *  this main() had to be renamed.
 *  
